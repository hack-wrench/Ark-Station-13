...
/datum/antagonist/ert/request_911/greet()
	...
	greeted_mob.playsound_local(greeted_mob, 'modularz_arkstation/modules/sounds-renewal/sound/antag/raiders.ogg', 100, FALSE, pressure_affected = FALSE, use_reverb = FALSE)

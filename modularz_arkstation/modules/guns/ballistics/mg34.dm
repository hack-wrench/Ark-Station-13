/obj/item/gun/ballistic/automatic/mg34
	...
	fire_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/mg34_fire.ogg'
...
/obj/item/gun/ballistic/automatic/mg34/mg42
	...
	fire_delay = 0.5
	fire_sound = 'modularz_arkstation/modules/guns/sound/guns/fire/mg42_fire.ogg'
...
/obj/item/gun/ballistic/automatic/mg34/mg42/proc/deploy_bipod(datum/datum_source, resting)
	...
	if(resting)
		...
		bipod_deployed = FALSE
		spread = SPREAD_UNDEPLOYED
	playsound(src, 'modularz_arkstation/modules/guns/sound/guns/fire/mg42_bipod.ogg', 100)
...
/obj/item/gun/ballistic/automatic/mg34/mg42/proc/process_heat()
	...
	if(barrel_heat >= 100)
		overheated = TRUE
		playsound(src, 'modularz_arkstation/modules/guns/sound/guns/fire/mg_overheat.ogg', 100)

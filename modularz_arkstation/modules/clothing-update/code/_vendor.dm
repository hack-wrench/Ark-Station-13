...
/obj/machinery/vending/wardrobe/sec_wardrobe //(RED) // ARK STATION EDIT || REDSEC
	...
	products = list(
		...
		/obj/item/clothing/suit/toggle/jacket/nova/sec = 5,
		...
		/obj/item/clothing/under/rank/security/nova/turtleneck = 10,
	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/toggle/jacket/nova/flannel/white = 5,

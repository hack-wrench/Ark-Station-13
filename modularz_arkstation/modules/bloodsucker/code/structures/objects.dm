...
/obj/item/stake
	...
	icon = 'modularz_arkstation/modules/bloodsucker/icons/obj/equipment/stakes.dmi'
	icon_state = "wood"
	inhand_icon_state = "wood"
	lefthand_file = 'modularz_arkstation/modules/bloodsucker/icons/mob/inhands/weapons/bloodsucker_lefthand.dmi'
	righthand_file = 'modularz_arkstation/modules/bloodsucker/icons/mob/inhands/weapons/bloodsucker_righthand.dmi'

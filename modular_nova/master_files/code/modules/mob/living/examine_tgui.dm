...
/datum/examine_panel/ui_data(mob/user)
	...
	var/obscured
	var/obscurity_examine_pref = preferences?.read_preference(/datum/preference/toggle/obscurity_examine) // ARK STATION EDIT
	var/ooc_notes = ""
	var/ooc_notes_nsfw = ""
	...
	if(ishuman(holder))
		...
		obscured = (holder_human.wear_mask && (holder_human.wear_mask.flags_inv & HIDEFACE)) && obscurity_examine_pref || (holder_human.head && (holder_human.head.flags_inv & HIDEFACE) && obscurity_examine_pref) // ARK STATION EDIT

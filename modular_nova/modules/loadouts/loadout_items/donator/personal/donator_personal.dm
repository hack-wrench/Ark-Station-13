...
/datum/loadout_item/gloves/hypnoring_coffee
	...
	// ARK STATION REMOVED: ckeywhitelist = list("coffeepot")

/datum/loadout_item/gloves/hypnoring_bippy
	name = "Hypnodemon's Ring"
	item_path = /obj/item/clothing/gloves/ring/hypno/bippys
	// ARK STATION REMOVED: ckeywhitelist = list("bippys")
...
/datum/loadout_item/head/goldengoggles
	...
	// ARK STATION REMOVED: ckeywhitelist = list("goldenalpharex")
...
/datum/loadout_item/under/jumpsuit/plasmaman_jax
	...
	// ARK STATION REMOVED: ckeywhitelist = list("candlejax")
	restricted_roles = list(JOB_RESEARCH_DIRECTOR, JOB_SCIENTIST, JOB_VIROLOGIST, JOB_GENETICIST) // ARK STATION EDIT
...
/datum/loadout_item/mask/composite_filtration
	...
	// ARK STATION REMOVED: ckeywhitelist = list("snakebittenn", "chillylobster", "candlejax", "theooz", "alvcyktor")
...
/datum/loadout_item/mask/luchador_mask
	...
	// ARK STATION REMOVED: ckeywhitelist = list("enzoman")
...
/datum/loadout_item/mask/caligram_visage_mask
	...
	// ARK STATION REMOVED: ckeywhitelist = list("farsightednightlight")
...
/datum/loadout_item/under/jumpsuit/captain_dress
	...
	// ARK STATION REMOVED: ckeywhitelist = list("netrakyram")
...
/datum/loadout_item/neck/kiaracloak
	...
	// ARK STATION REMOVED: ckeywhitelist = list("inferno707")
...
/datum/loadout_item/suit/delta_coat
	...
	// ARK STATION REMOVED: ckeywhitelist = list("deltatri")
...
/datum/loadout_item/neck/silvercross
	...
	// ARK STATION REMOVED: ckeywhitelist = list("m97screwsyourparents")
...
/datum/loadout_item/mask/octusvox
	...
	// ARK STATION REMOVED: ckeywhitelist = list("octus")

/datum/loadout_item/glasses/roseglasses
	name = "Rose-Colored Glasses"
	item_path = /obj/item/clothing/glasses/rosecolored
	// ARK STATION REMOVED: ckeywhitelist = list("1ceres", "irrigoimport", "zeskorion", "wizardlywoz", "duckymomo", "samarai1000", "funkyfetusstrikesback", "m97screwsyourparents", "lynxqueen", "kaynite", "mahalia", "sapphoqueer", "emmakisst", "ceasethebridge", "valorthix" )
...
/datum/loadout_item/suit/gorlex_harness
	...
	// ARK STATION REMOVED: ckeywhitelist = list("1ceres")
...
/datum/loadout_item/glasses/roseeyepatch
	...
	// ARK STATION REMOVED: ckeywhitelist = list("kaynite")
...
/datum/loadout_item/neck/fluffycloak
	...
	// ARK STATION REMOVED: ckeywhitelist = list("realwinterfrost")
...
/datum/loadout_item/pocket_items/tacticalbrush
	...
	// ARK STATION REMOVED: ckeywhitelist = list("weredoggo")
...
/datum/loadout_item/suit/rainbowcoat
	...
	// ARK STATION REMOVED: ckeywhitelist = list("dudewithatude")
...
/datum/loadout_item/under/jumpsuit/nt_idol
	...
	// ARK STATION REMOVED: ckeywhitelist = list("tetrako")
	restricted_roles = list(JOB_NT_REP)
...
/datum/loadout_item/under/jumpsuit/bubbly_clown
	...
	// ARK STATION REMOVED: ckeywhitelist = list("boisterousbeebz", "aether217")
...
/datum/loadout_item/suit/elofy
	...
	// ARK STATION REMOVED: ckeywhitelist = list("october23")
	restricted_roles = list(JOB_HEAD_OF_SECURITY)
...
/datum/loadout_item/suit/lt3_armor
	...
	// ARK STATION REMOVED: ckeywhitelist = list("lt3")
...
/datum/loadout_item/inhand/sqn_box
	...
	// ARK STATION REMOVED: ckeywhitelist = list("sqnztb")
...
/datum/loadout_item/under/jumpsuit/noble_gambeson
	...
	// ARK STATION REMOVED: ckeywhitelist = list("grasshand")
...
/datum/loadout_item/under/miscellaneous/rem
	...
	// ARK STATION REMOVED: ckeywhitelist = list("ignari")
...
/datum/loadout_item/inhand/pet/mrfluff_mothroach
	...
	// ARK STATION REMOVED: ckeywhitelist = list("centralsmith")
...
/datum/loadout_item/suit/desminus
	...
	// ARK STATION REMOVED: ckeywhitelist = list("desminus", "junglerat", "deadmonwonderland")
...
/datum/loadout_item/pocket_items/akarimod
	...
	// ARK STATION REMOVED: ckeywhitelist = list("samman166", "cainedclxvi")
...
/datum/loadout_item/pocket_items/mrsanderp_cookbook
	...
	// ARK STATION REMOVED: ckeywhitelist = list("mrsanderp")
...
/datum/loadout_item/under/jumpsuit/ecologist
	...
	// ARK STATION REMOVED: ckeywhitelist = list("deadmonwonderland", "pyritechimera", "darkinite", "wivernshy")
...
/datum/loadout_item/suit/elysiancoat
	...
	// ARK STATION REMOVED: ckeywhitelist = list("courierasy")

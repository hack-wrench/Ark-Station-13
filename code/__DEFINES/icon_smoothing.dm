...
#define SMOOTH_GROUP_GRILLE S_TURF(66)
// ARK STATION ADDITION END
#define MAX_S_TURF 66 //ARK STATION EDIT | 65 //Always match this value with the one above it. // NOVA EDIT CHANGE - Original: #define MAX_S_TURF 61

...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	RADIO_KEY_CHURCH = RADIO_CHANNEL_CHURCH, // ARK STATION ADDITION || CHURCH
	...
	"о" = RADIO_CHANNEL_CHURCH, // ARK STATION ADDITION || CHURCH

	// Faction
	"е" = RADIO_CHANNEL_SYNDICATE,
	"н" = RADIO_CHANNEL_CENTCOM,
	"а" = RADIO_CHANNEL_FACTION, // ARK-NOVA EDIT ADDITION - FACTION
	"й" = RADIO_CHANNEL_CYBERSUN, // ARK-NOVA EDIT ADDITION - MAPPING
	"ц" = RADIO_CHANNEL_INTERDYNE, // ARK-NOVA EDIT ADDITION - MAPPING
	"з" = RADIO_CHANNEL_GUILD, // ARK-NOVA EDIT ADDITION - MAPPING
	"к" = RADIO_CHANNEL_TARKON, // ARK-NOVA EDIT ADDITION - MAPPING

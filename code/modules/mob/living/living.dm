...
/mob/living/proc/admin_give_guardian(mob/admin)
	...
	var/picked_color = tgui_color_picker(admin, "Set the guardian's color, cancel to let player set it.", "Guardian Controller", "#ffffff") // ARK STATION EDIT: TGUI COLOR PICKER

...
/datum/preferences/proc/refresh_membership()
	...
	// if(unlock_content || donator_status) // NOVA EDIT CHANGE - ORIGINAL: if(unlock_content) // ARK STATION REMOVED
	max_save_slots = 50 //NOVA EDIT - ORIGINAL: max_save_slots = 8 // ARK STATION EDIT - Сместил на один таб влево.

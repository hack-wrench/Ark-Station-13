...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_FAST_RUNNER" = TRAIT_FAST_RUNNER, // ARK STATION 13 QUIRK
		"TRAIT_SLOW_RUNNER" = TRAIT_SLOW_RUNNER, // ARK STATION 13 QUIRK
		"TRAIT_JUMPER" = TRAIT_JUMPER, // ARK STATION 13 QUIRK

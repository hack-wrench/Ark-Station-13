...
/obj/item
	...
	var/female_sprite = FALSE // ARK STATION ADDITION
...
/obj/item/proc/pick_painting_tool_color(mob/user, default_color)
	var/chosen_color = tgui_color_picker(user,"Pick new color", "[src]", default_color) //ARK STATION EDIT: TGUI COLOR PICKER

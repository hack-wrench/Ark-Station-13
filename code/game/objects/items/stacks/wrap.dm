...
/obj/item/stack/wrapping_paper/click_alt(mob/user)
	var/new_base = tgui_color_picker(user, "", "Select a base color", color) // ARK STATION EDIT: TGUI COLOR PICKER
	var/new_ribbon = tgui_color_picker(user, "", "Select a ribbon color", color) // ARK STATION EDIT: TGUI COLOR PICKER

...
GLOBAL_LIST_INIT(default_radio_channels, list(
	...
	RADIO_CHANNEL_CHURCH = FREQ_CHURCH, // ARK STATION ADDITION || CHURCH
...
GLOBAL_LIST_INIT(reserved_radio_frequencies, list(
	...
	"[FREQ_CHURCH]" = RADIO_CHANNEL_CHURCH, // ARK STATION ADDITION || CHURCH
...
GLOBAL_LIST_INIT(reserved_radio_colors, list(
	...
	RADIO_CHANNEL_MEDICAL = "#3f7546", // ARK STATION EDIT
	RADIO_CHANNEL_CHURCH = "#b6b6b6", // ARK STATION ADDITION
